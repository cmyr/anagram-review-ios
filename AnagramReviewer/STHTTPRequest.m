...
@property (nonatomic, strong) NSString *POSTFileMimeType;
@property (nonatomic, strong) NSString *POSTFileName;
@property (nonatomic, strong) NSString *POSTFileParameter;
@end
